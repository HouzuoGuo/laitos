## Introduction
Find text in AES-encrypted text files, such as contact list or password book.
...
4. There is now an important decision to make. The app configuration stores part of the key prefix, and when
   ...
   time you use this app. Do not reveal too much of the key in app configuration, the balance between
...
5. Note down the entire IV value and key prefix of your desired length, they will now be used in app configuration.

Repeat the procedure for as many files as you wish.
