...
type Browser struct {
	Renderers *browser.Renderers `json:"Browsers"` // Renderers configure and manage phantomJS processes.
	renderer  *browser.Renderer  `json:"-"`        // renderer is the one and only browser instance tied to this feature
