...
Otherwise, an activate systemd-resolved daemon program listens on 127.0.0.53:53 and will not let laitos DNS server listen on all network interfaces (0.0.0.0).
*/
func DisableInterferingResolved() (relevant bool, out string) {
	...
	// Overwrite its content with a sane set of public DNS resolvers matching that default list from dnsd.go
	newContent := `
# Generated by laitos software - DisableInterferingResolved
options rotate timeout:3 attempts:3
# Quad9, SafeDNS, OpenDNS, AdGuard, Neustar primary
nameserver 9.9.9.9
nameserver 195.46.39.39
nameserver 208.67.222.222
nameserver 176.103.130.130
nameserver 156.154.70.2
# Quad9, SafeDNS, OpenDNS, AdGuard, Neustar secondary
