...
func TestSMTPD_StartAndBlock(t *testing.T) {
	...
	daemon.MailProcessor.ReplyMailClient = inet.MailClient{
		MailFrom: "howard@localhost",
		MTAHost:  "127.0.0.1",
		MTAPort:  61358,
	}
